      ...
      <div className="mt-12">
        <Card className="overflow-hidden">
          ...
          <CardContent className="space-y-4 font-body text-base leading-relaxed text-foreground/80">
            ...
            <p>
              Nuestro compromiso va más allá de ofrecer perfumes excepcionales. Nos esforzamos por crear una experiencia. Desde nuestras recomendaciones personalizadas hasta nuestro empaque de lujo, cada detalle está diseñado pensando en ti. Te invitamos a explorar nuestra colección y encontrar el aroma que cuenta tu historia.
            </p>
          </CardContent>
        </Card>
      </div>
